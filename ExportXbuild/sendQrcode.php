...
$downloadpngTxt=$argv[1];
$downloadpngUrl=$argv[2];
$createTime=$argv[3];//获取构建时间
$createAuther=$argv[4];//获取生成人
$downloadUrl=$argv[5];//获取HTML
...
$title="下载测试版";
$message="## ${createAuther}于${createTime}创建：\n > #### 描述：${downloadpngTxt} \n > #### [下载页](${downloadUrl}) \n > ##### ${sendTime}发布 \n";
